...
class ListsApi(object):
    ...
    def get_list(self, list_id, **kwargs):  # noqa: E501
        ...
        :param list[str] fields: A comma-separated list of fields to return. Reference parameters of sub-objects with dot notation.
        :param list[str] exclude_fields: A comma-separated list of fields to exclude. Reference parameters of sub-objects with dot notation.
        :param bool include_total_contacts: Return the total_contacts field in the stats response, which contains an approximate contact count for the given list.
    ...
    def preview_segment(self, list_id, body, **kwargs):  # noqa: E501
        """Preview segment  # noqa: E501

        Preview a segment of users by sending conditions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.preview_segment(list_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.preview_segment_with_http_info(list_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.preview_segment_with_http_info(list_id, body, **kwargs)  # noqa: E501
            return data

    def preview_segment_with_http_info(self, list_id, body, **kwargs):  # noqa: E501
        """Preview segment  # noqa: E501

        Preview a segment of users by sending conditions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.preview_segment_with_http_info(list_id, body, async_req=True)
        >>> result = thread.get()
