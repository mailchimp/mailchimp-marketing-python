...
class ListsApi(object):
    ...
    def get_all_surveys_for_list(self, list_id, **kwargs):  # noqa: E501
        """Get information about all surveys for a list  # noqa: E501

        Get information about all available surveys for a specific list.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_surveys_for_list(list_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_surveys_for_list_with_http_info(list_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_surveys_for_list_with_http_info(list_id, **kwargs)  # noqa: E501
            return data

    def get_all_surveys_for_list_with_http_info(self, list_id, **kwargs):  # noqa: E501
        """Get information about all surveys for a list  # noqa: E501

        Get information about all available surveys for a specific list.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_surveys_for_list_with_http_info(list_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_surveys_for_list" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'list_id' is set
    ...
    def get_survey(self, list_id, survey_id, **kwargs):  # noqa: E501
        """Get survey  # noqa: E501

        Get details about a specific survey.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_survey(list_id, survey_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_survey_with_http_info(list_id, survey_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_survey_with_http_info(list_id, survey_id, **kwargs)  # noqa: E501
            return data

    def get_survey_with_http_info(self, list_id, survey_id, **kwargs):  # noqa: E501
        """Get survey  # noqa: E501

        Get details about a specific survey.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_survey_with_http_info(list_id, survey_id, async_req=True)
        >>> result = thread.get()
